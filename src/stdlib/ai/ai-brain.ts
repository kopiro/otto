...
export class AIBrain {
  ...
  private getDocumentationJSONAIOutput(): Record<keyof AIOutput, string> {
    return {
      ...
      emotionsUpdates: `A valid JSON object representing the increment/decrement in emotion map you're feeling towards this person. Maximum increment/decrement per emotion is ${this.config.emotionMaxIncrement}.`,
    };
  }
