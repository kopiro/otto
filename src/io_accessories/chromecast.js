...
exports.canHandleOutput = function (e, session) {
  if (e.payload.video && (e.payload.video.youtube || e.payload.video.uri)) return IOManager.CAN_HANDLE_OUTPUT.YES_AND_BREAK;
  if (e.payload.image && e.payload.image.uri) return IOManager.CAN_HANDLE_OUTPUT.YES_AND_BREAK;
  if (e.payload.music && (e.payload.music.spotify || e.payload.music.uri)) return IOManager.CAN_HANDLE_OUTPUT.YES_AND_BREAK;
};
